...
void test_bitrate_atomic_sync() {
    ...
    memset(pkt_100, 0, 188); pkt_100[0] = 0x47; pkt_100[1] = 0x01; pkt_100[3] = 0x10;
    memset(pkt_null, 0, 188); pkt_null[0] = 0x47; pkt_null[1] = 0x1F; pkt_null[2] = 0xFF; pkt_null[3] = 0x10;
