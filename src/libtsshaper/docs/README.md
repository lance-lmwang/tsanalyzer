# Engine Documentation: libtsshaper (Professional T-STD Multiplexer)

This directory contains the authoritative specifications and operational guides for the `libtsshaper` implementation, a standalone, industrial-grade T-STD multiplexing and pacing engine.
...
- [**Verification Guide**](./VERIFICATION_GUIDE.md): Standard Operating Procedure (SOP) for regression testing and performance validation.
...
*   **Standalone Portability**: Fully decoupled from FFmpeg, compiling into a pure C ABI-stable library (`libtsshaper.a`).
