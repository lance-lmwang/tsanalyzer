...
## 1. Global Standards
- **TsAnalyzer API Port**: `9090` (Default)
- **Grafana UI Port**: `3000` (Standard)
- **Base URL**: `http://<device-ip>:9090/api/v1`
...
curl -X POST http://192.168.7.2:9090/api/v1/config/streams \
     -H "Content-Type: application/json" \
     -d '{"stream_id": "HK-PROD", "url": "srt://0.0.0.0:9001", "latency_ms": 400}'

# Delete a stream and free resources
curl -X DELETE http://192.168.7.2:9090/api/v1/config/streams/HK-PROD
```
