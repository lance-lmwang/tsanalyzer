...
DST="/home/lmwang/dev/cae/tsanalyzer/output/promax_seq.ts"

# 1. 以 Strict 模式 (Mode 1) 转码 (模拟 PROMAX 中所见的平滑流)
...
# 2. 导出 1.5s 滑动窗口原始序列数据 (按 50ms 采样)
